...
module "azuread_application" {
  ...
  redirect_uris                 = ["https://${local.name_prefix}-webapp.azurewebsites.net/", "https://${local.name_prefix}-webapp.azurewebsites.net/login/callback", "https://${local.name_prefix}-webapp.azurewebsites.net/accounts/microsoft/login/callback/", "https://dev.laurel-ag.biz/", "https://dev.laurel-ag.biz/login/callback/", "https://dev.laurel-ag.biz/accounts/microsoft/login/callback/", "https://laurel-hsfd.onrender.com/", "http://localhost:8000/accounts/microsoft/login/callback/"]
...
module "linux_app_services" {
  ...
  app_settings = {
    ...
    "DB_NAME"                 = "${var.unique_name}-${var.environment}"
